...
def main():
    ...
    parser.add_argument('--argument', type=str, default="False",
                        help='For Saving and loading the current Model')
    ...
    if args.argument == "False":
        ...
        directory = "./result/cifar10/{}/epoch{}_batch{}_lr{:.3f}_seed{}_argumented".format(args.model, args.epochs, args.batch_size, args.lr, args.seed)
        location = "./result/cifar10/{}/epoch{}_batch{}_lr{:.3f}_seed{}_argumented/checkpoints/single_mlp.pt".format(args.model, args.epochs, args.batch_size, args.lr, args.seed)
        os.makedirs("./result/cifar10/{}/epoch{}_batch{}_lr{:.3f}_seed{}_argumented".format(args.model, args.epochs, args.batch_size, args.lr, args.seed), exist_ok=True)
