...
def main():
    ...
    directory = "./result/cifar10/MLP_single/epoch{}_batch{}_lr{:.3f}_seed{}".format(args.epochs, args.batch_size, args.lr, args.seed)
    location = "./result/cifar10/MLP_single/epoch{}_batch{}_lr{:.3f}_seed{}/checkpoints/single_mlp.pt".format(args.epochs, args.batch_size, args.lr, args.seed)
    os.makedirs("./result/cifar10/MLP_single/epoch{}_batch{}_lr{:.3f}_seed{}".format(args.epochs, args.batch_size, args.lr, args.seed), exist_ok=True)
